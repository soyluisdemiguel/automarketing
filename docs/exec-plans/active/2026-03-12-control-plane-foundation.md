...
- Product, architecture, MCP contract, and skill or automation expectations are now documented.
- No runtime code, migrations, provider adapters, or conformance harness exist yet.
- Validation currently covers documentation only.
